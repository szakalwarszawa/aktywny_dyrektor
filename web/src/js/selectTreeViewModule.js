...
(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    Tree.prototype.createAst = function (options) {
      ...
      options.each(function () {
        ...
        var item = Ast.createItem({
          ...
          dateRange: option.getAttribute('data-range'),
          expired: option.getAttribute('data-expired'),
    ...
    exports.createSelection = function (astItem, createCheckboxes, disableCheckboxes) {
      var props = {
        class: 'item' + (astItem.expired == 1? ' alert-danger': ''),
        'data-key': astItem.id,
      ...
      if (hasDescription) {
        var popup = exports.createNode('span', { class: 'description'});
        popup.innerHTML = '<i class="fal fa-unlock"></i>';
      ...
      if (!createCheckboxes) {
        ...
        label.innerHTML = label.innerText + '<i class="pull-right f-weight-300">' + astItem.dateRange + '</i>';
...
export default $(function() {
    ...
    function onTreeUpdate(allSelectedItems, addedItems, removedItems)
    {
        if (allSelectedItems.length === maxSelections) {
            alert('Uwaga! Z przyczyn technicznych możesz zaznaczyć do '+ maxSelections +' uprawnień do odebrania na jednym wniosku. System odznaczy nadmiarowe uprawnienia. Aby odebrać kolejne uprawnienia, złóż jeszcze jeden wniosek');
        }
    }
})
