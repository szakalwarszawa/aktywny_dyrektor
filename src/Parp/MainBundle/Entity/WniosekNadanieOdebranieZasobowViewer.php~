 ...
 * UserZasoby
 *
 * @ORM\Table(name="wniosek_nadanie_odebranie_zasobow_viewer")
 * @ORM\Entity(repositoryClass="Parp\MainBundle\Entity\WniosekNadanieOdebranieZasobowViewerRepository")
 * @APY\DataGridBundle\Grid\Mapping\Source(columns="id,samaccountname,zasobId")
 * @Gedmo\Mapping\Annotation\SoftDeleteable(fieldName="deletedAt", timeAware=false)
 * @Gedmo\Mapping\Annotation\Loggable(logEntryClass="Parp\MainBundle\Entity\HistoriaWersji")
 */
class WniosekNadanieOdebranieZasobowViewer
{
    /**
     * @var integer
     *
    ...
    */
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="WniosekNadanieOdebranieZasobow", inversedBy="viewers")
