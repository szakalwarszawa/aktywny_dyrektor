 ...
 * @ORM\Entity(repositoryClass="ParpV1\MainBundle\Entity\ZasobyRepository")
 * @APY\DataGridBundle\Grid\Mapping\Source(columns="id,nazwa,opisZasobu,wlascicielZasobu,administratorZasobu,administratorTechnicznyZasobu,wniosekUtworzenieZasobu.wniosek.numer,wniosekUtworzenieZasobu.id")
