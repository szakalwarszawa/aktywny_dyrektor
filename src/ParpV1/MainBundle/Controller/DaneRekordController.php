...
class DaneRekordController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        // Edycja konta
        $rowAction2 = new RowAction('<i class="fas fa-pencil"></i> Edycja', 'danerekord_edit');
        $rowAction2->setColumn('akcje');
        $rowAction2->addAttribute('class', 'btn btn-success btn-xs');

        // Edycja konta
        $rowAction3 = new RowAction('<i class="far fa-trash-alt"></i> Skasuj', 'danerekord_delete');
    ...
    private function createCreateForm(DaneRekord $entity)
    {
        ...
        $form->add('submit', SubmitType::class, array('label' => 'Utwórz DaneRekord', 'attr' => array('class' => 'btn btn-success' )));
    ...
    */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ...
            ->setMethod('DELETE')
            ->add('submit', SubmitType::class, array('label' => 'Skasuj DaneRekord','attr' => array('class' => 'btn btn-danger' )))
            ->getForm()
        ;
    }
}
