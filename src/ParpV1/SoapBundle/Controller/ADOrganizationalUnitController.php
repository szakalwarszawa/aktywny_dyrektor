...
class ADOrganizationalUnitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        // Edycja konta
        $rowAction2 = new RowAction('<i class="fas fa-pencil"></i> Edycja', 'adorganizationalunit_edit');
        $rowAction2->setColumn('akcje');
        $rowAction2->addAttribute('class', 'btn btn-success btn-xs');

        // Edycja konta
        $rowAction3 = new RowAction('<i class="far fa-trash-alt"></i> Skasuj', 'adorganizationalunit_delete');
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->addFlash('warning', 'ADOrganizationalUnit został utworzony.');
    ...
    private function createCreateForm(ADOrganizationalUnit $entity)
    {
        ...
        $form->add('submit', SubmitType::class, array('label' => 'Utwórz ADOrganizationalUnit', 'attr' => array('class' => 'btn btn-success' )));
    ...
    */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ...
            ->setMethod('DELETE')
            ->add('submit', SubmitType::class, array('label' => 'Skasuj ADOrganizationalUnit','attr' => array('class' => 'btn btn-danger' )))
            ->getForm()
        ;
    }
}
